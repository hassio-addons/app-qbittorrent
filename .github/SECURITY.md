...
[**Report a vulnerability**](https://github.com/hassio-addons/app-qbittorrent/security/advisories/new)
...
- Issues in qBittorrent itself; please report those directly to the
  [qBittorrent project](https://github.com/qbittorrent/qBittorrent/security/policy).
...
This security policy covers the qBittorrent app in this repository: the app
